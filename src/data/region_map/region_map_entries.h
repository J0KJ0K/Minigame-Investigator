...
static const u8 sMapName_PetalburgCity[] = _("MILES' ROOM");
...
static const u8 sMapName_Freddys1[] = _("OLD FREDDY FAZBEAR'S");
static const u8 sMapName_Freddys2[] = _("NEW FREDDY FAZBEAR'S");
...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [MAPSEC_ROUTE_FREDDY]                  = { 4, 10, 1, 1, sMapName_Freddys1},
    [MAPSEC_ROUTE_FREDDY_2]                  = { 2,  9, 2, 1, sMapName_Freddys2},
