...
const u32 gTrainerFrontPic_Scott[] = INCBIN_U32("graphics/trainers/front_pics/brendan.4bpp.lz");
const u32 gTrainerFrontPic_Yeva[] = INCBIN_U32("graphics/trainers/front_pics/may.4bpp.lz");
