const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BRENDAN] = TRAINER_PIC_SCOTT,
    [FACILITY_CLASS_MAY] = TRAINER_PIC_YEVA,
    
    [FACILITY_CLASS_BRENDAN_2] = TRAINER_PIC_SCOTT,
    [FACILITY_CLASS_BRENDAN_3] = TRAINER_PIC_SCOTT,

    [FACILITY_CLASS_MAY_2] = TRAINER_PIC_YEVA,
    [FACILITY_CLASS_MAY_3] = TRAINER_PIC_YEVA,
};
