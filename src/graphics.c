...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/title_beta.gbapal"/*,
...
const u32 gTitleScreenPressStartGfx[]      = INCBIN_U32("graphics/title_screen/press_start_2.4bpp.lz");
