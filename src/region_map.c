...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_FREDDY] = {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_FREDDY_2] = {MAP_GROUP(ROUTE102), MAP_NUM(ROUTE102), HEAL_LOCATION_NONE},
