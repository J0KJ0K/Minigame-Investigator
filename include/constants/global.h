...
#define DEFAULT_COSTUME 0   // HUMAN PROTAGONIST
#define GLASSES         18   // HUMAN PROTAGONIST WITH GLASSES
#define COSTUME_FREDDY  1   // FNAF 3 NIGHT 1 AND TAKE CAKE TO THE CHILDREN
#define COSTUME_BONNIE	2   // FNAF 3 NIGHT 2
#define COSTUME_CHICA	3   // FNAF 3 NIGHT 3
#define COSTUME_FOXY	4   // FNAF 3 NIGHT 4 AND FOXY GO! GO! GO!
#define COSTUME_GHOST	5   // FNAF 3 NIGHT 5

#define COSTUME_PUPPET  6   // FNAF 6 AND GIVE GIFTS GIVE LIFE
#define COSTUME_WFREDDY	7   // SAVETHEM

#define COSTUME_BABY    8   // SISTER LOCATION
#define COSTUME_CRYING	9   // FNAF 4 ALL NIGHTS
#define COSTUME_ORANGE	10  // MIDNIGHT MOTORIST
#define COSTUME_SUSIE	11  // FRUITY MAZE

// FNAF 3 GOOD ENDING (MIGHT NOT EVEN BE IN THE GAME FOR LACK OF CANON)
#define COSTUME_BB      12  // B.B.'S AIR ADVENTURE
#define COSTUME_MANGLE	13  // MANGLE'S QUEST
#define COSTUME_TCHICA  14// CHICA'S PARTY
#define COSTUME_FREDBEAR	15  // FREDBEAR
#define COSTUME_SHBONNIE	16  // SHADOW BONNIE
#define COSTUME_PUPGHOST	17  // PUPPET GHOST

#define COSTUME_COUNT   19
